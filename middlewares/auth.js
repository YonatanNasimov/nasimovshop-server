...
exports.auth = (req,res,next) => {
  ...
  try{
    ...
    console.log(err);
    return res.status(401).json({msg:"Token invalid or expired, log in again or you a hacker!"})
  }
}
...
exports.authAdmin = (req,res,next) => {
  ...
  try{
    ...
    console.log(err);
    return res.status(401).json({msg:"Token invalid or expired, log in again or you hacker!", err})
  }
}